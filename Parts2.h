...
public:
	...
	static void DrowCarriage(float shutdownLevel,int firstImage,int secondImage,int thirdImage,int game_machine,int game_machine_screan,int game_place,int ImageSofa,int image,int monitor,int case_left,int case_front,int case_top);
	static void DrowCarriageWithoutDoors(Point startPoint, float distanceX, float distanceY, float distanceZ, int windowsNum , float shutdownLevel , int firstImage,int secondImage,int thirdImage);
	...
	//////////////////////////////////////
	void static drawBed(int texBed);
	void static drawCubeTexture1(Point p,int img);
	void static draw_sleeping_carriage(int img);
	void static drawCubeTexture3(Point p,int img5);
	void static drawCubeTexture2(Point p,int img3);
	void static drawBedTexture1(int img,int img2,int img3);
	void static draw_sleeping_carriageTexture(int img,int img2,int img3);
};
